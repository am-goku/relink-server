    ...
    try {
      ...
      const template = `<!DOCTYPE html>
                ...
                <head>
                  <meta charset="UTF-8">
                  <meta name="viewport" content="width=device-width, initial-scale=1.0">
                  <title>ReLink Verification Email</title>
                </head>
                <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
                  <div style="background-color: #ffffff; max-width: 600px; margin: 0 auto; padding: 20px; border-radius: 5px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
                    <h2 style="color: #333; text-align: center;">ReLink Email Verification</h2>
                    <p>Hello ${username},</p>
                    <p>You have requested to change password for the ReLink. Please click the following link and verify user to complete the process:</p>
                    <p style="text-align: center; font-size: 24px;"><a href=${link} >Click here to verify</a> </p>
                    <p>If you did not request this, please ignore this message. The link is valid only for 30 minutes.</p>
                    <p>Thank you for using ReLink.</p>
                    <p style="text-align: center;">Best regards,<br>The ReLink Team</p>
                  </div>
                </body>
